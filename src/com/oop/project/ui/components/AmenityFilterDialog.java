...
public class AmenityFilterDialog extends JDialog {
    ...
    public AmenityFilterDialog(Frame owner, List<Integer> previouslySelectedIds) {
        super(owner, "Select Amenities", true);
    ...
    private void loadAmenities() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Failed to load amenities: " + e.getMessage(),
    ...
    private void layoutComponents() {
        ...
        JButton okButton = new StyledButton("OK", Theme.PRIMARY);
        JButton cancelButton = new StyledButton("Cancel", Theme.TEXT_SECONDARY);
    ...
    // Helper class for checkbox rendering
    ...
    private static class AmenityCheckboxRenderer extends JCheckBox implements ListCellRenderer<AmenityItem> {
        @Override
